...
@section('content')
    ...
    <!-- Modal toggle -->
    <button data-modal-target="protokol" data-modal-toggle="protokol" type="button" class="block max-w-sm p-6 bg-white rounded-lg shadow transition">
        <h5 class="bottom-4 mb-2 text-2xl font-bold tracking-tight text-batik text-center dark:text-almet"
            data-modal-target="keprotokolan" data-modal-toggle="keprotokolan" type="button">
