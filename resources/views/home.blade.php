    ...
    <section id="home" class="pt-36 pb-24 ">
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2 relative" data-aos="fade-right">
                    <h1 class="text-xl font-extrabold text-orange-600">
                        Unit Kreativitas Mahasiswa<span class="block font-bold text-dark text-4xl text-black ">Korps
                            Protokoler
                            Mahasiswa</span>
                    </h1>
                    ...
                    <span class="absolute top-0 -z-10 right-0 scale-50 -translate-y-32 hover:skew-x-6">
                ...
                <div class="w-full self-end px-4 lg:w-1/2 " data-aos="fade-up-left">
                    <div class="relative mt-10">
                        <img src="asset/img/dutaunisma_nonbg.png " alt="UKM KPM"
                            class="max-w-full mx-auto hover:translate-x-2 transition ease-out">
                        <span class="absolute bottom-0 translate-x-40 -z-10 -translate-y-32 scale-150">
                            <svg class="" width="280" height="280" viewBox="0 0 280 280" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <circle cx="140" cy="140" r="140" fill="#EA580C"
                                    fill-opacity="0.7" />
                                <circle cx="257" cy="257" r="17" fill="#EA580C"
                                    fill-opacity="0.7" />
                            </svg>
                        </span>
                    </div>
            ...
            <div class="w-full px-4 pt-24">
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full px-4 mt-5 pt-4 self-center lg:w-1/2">
                        <span class="relative">
                            ...
                            <hr class="mb-4 w-72 p-[3px] bg-slate-600 -translate-y-4">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full px-4 lg:w-1/2 mt-5 pt-4" data-aos="fade-right">
                        ...
                        <p class="font-normal text-gray-700 dark:text-gray-400">UKM Korps Protokoler Mahasiswa (KPM)
                    ...
                    <div class="w-full px-4 lg:w-1/2 mt-5 pt-4" data-aos="fade-right">
                        ...
                        <ul>
                            <li>1. Menjalankan fungsi dalam rangka mengharumkan nama baik universitas melalui peningkatan
                                hubungan baik di tingkat Regional, Nasional, maupun Internasional</li>
                            <li>2. Membentuk mahasiswa pilihan yang andal dan profesional dalam menjalankan bidang
                                keprotokolan, kehumasan, dan kedutaan </li>
                            <li>3. Menjalin hubungan baik dengan mitra internal maupun eksternal melalui peningkatan kerja
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center lg:w-1/2">
                    ...
                    <a href="#">
                        <button class="mt-5 px-6 py-4 bg-orange-600 text-white font-bold rounded-xl hover:opacity-70">Baca
                            Lebih Lanjut</button>
                    </a>
                </div>
