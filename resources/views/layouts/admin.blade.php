...
<body>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
                        ...
                        <span
                            class="self-center text-md font-semibold sm:text-xl whitespace-nowrap dark:text-white">Unit
                            Kreatifitas Mahasiswa <br><span
                                class="text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
                                Korps Protokoler Mahasiswa UNISMA
                            </span></span>
    ...
    <aside id="logo-sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 mt-10">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="blog.php"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Berita Acara</span>
                    </a>
                </li>
                <li>
                    <a href="galeri.php"
