...
@section('content')
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class=" relative w-full self-center px-4 lg:w-1/2 " data-aos="fade-right" data-aos-duration="800">
                    ...
                    {{-- <p class="leading-relaxed font-body"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ducimus
                        officia corrupti blanditiis accusantium ut nemo!</p> --}}
                    <!-- Social Media -->
                    {{-- <div class="flex">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/tTRyfemse9Y"
            ...
            <div class="w-full px-4 pt-8">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full px-4 lg:w-2/3">
                        ...
                        <div class="w-full px-4 mt-5 pt-4 text-justify flex" data-aos="fade-right"
                    ...
                    <div class="w-full px-4 lg:w-1/3 relative" data-aos-duration="1500" data-aos="zoom-in">
    ...
    <section id="news" class="pt-36 pb-32 bg-slate-100">
        <div class="container">
            ...
            <div class="mt-16 text-center justify-center">
                <a href="/news"
                    class="py-2 px-4 font-bold text-white bg-batik dark:bg-almet hover:opacity-70  text-center rounded-xl">Lihat
                    lebih banyak </a>
            </div>
        </div>
    </section>
